...
task FPSDrive()
{
	while(true)
	{
		...
		motorTrigger(backleft,-x*.75,y*.75
		,z);
	}
}
...
//this code is not the correct way to do it
...
//not the correct way to do this
	...
	if (joy1Btn(5) == 1)
	{
		servo[rollingBack] = 250; //clamp onto rolling goal in back of robot
	}
	...
	if (joy1Btn(5) == 1)
	{
		servo[rollingSide] = 250; //clamp onto rolling goal on side of robot
	}
